...
{
    operator fun get(serviceContentTypeDownload: ServiceContentTypeDownload,
                     contentServiceStatusObserver: ContentServiceStatusObserver): AsyncHttpClient
    {
        ...
        client.get(serviceContentTypeDownload.url, object : AsyncHttpResponseHandler()
        {
            ...
            override fun onSuccess(statusCode: Int, headers: Array<Header>, response: ByteArray)
            {
                ...
                serviceContentTypeDownload.contentServiceObserver.onSuccess(
            ...
            override fun onRetry(retryNo: Int)
            {
                ...
                serviceContentTypeDownload.contentServiceObserver.onRetry(serviceContentTypeDownload,
                    retryNo)
            }
